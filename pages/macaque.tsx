...
const channel_text = ['Macaque','Macaque','Macaque','Macaque','Macaque','Macaque','Macaque','Macaque']

const Macaque : React.FC<Props> = () => {
    ...
    const fetchData = async () => {
        ...
        .then(response => {
            let jsonData : RadioData = JSON.parse(JSON.stringify(response.data[2]))
    ...
    <div className={styles.App}>
        <Head>
            ...
            <meta name="description" content="Listen to our macaque mixtape by @adiloooh" />
        ...
        <animated.div style={style} className={styles.App_disabled}>
            ...
            <Navbar channel_selected={"macaque"} />
